                        ...
                        UWORD Color_Foreground, UWORD Color_Background)
{
    ...
    while (*(pstr+i) != '\0')
    {
        ...
        ds_get_bitmap(char_cn_un,bitmap,&box_w,&box_h,&offset_x,&offset_y);
...
void Paint_DrawString_piture(UWORD Xstart, UWORD Ystart, unsigned char *pbuf ,int plen,int pxsize,
                        UWORD Color_Foreground, UWORD Color_Background)
{
...
unsigned char gImage_last_page[2888];
...
void ds_paint_image_copy(){
    memcpy(gImage_last_page,Paint._Image,2888);
}
